...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		RGB_TOG, KC_LGUI, TG(1), KC_SPC, KC_TAB, KC_ESC, LT(2, KC_BSPC), LT(3, KC_ENT), KC_INS, RGB_M_P),
	...
	LAYOUT(
		...
		RGB_M_SW, RGB_M_B, RGB_M_G, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
